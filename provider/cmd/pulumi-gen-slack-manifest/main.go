...
import (
	...
	providerVersion "github.com/prodoelmit/pulumi-slack-manifest-native/provider/pkg/version"
...
// BaseDir is the path to the base pulumi-slack-manifest directory.
var BaseDir string
...
func main() {
	flag.Usage = func() {
		const usageFormat = "Usage: %s <language> <swagger-or-schema-file> <root-pulumi-slack-manifest-dir>"
