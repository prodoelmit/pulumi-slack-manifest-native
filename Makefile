PROJECT_NAME := Pulumi slack-manifest Resource Provider

PACK             := slack-manifest
PACKDIR          := sdk
PROJECT          := github.com/prodoelmit/pulumi-slack-manifest-native
NODE_MODULE_NAME := @pulumi/slack-manifest
NUGET_PKG_NAME   := Pulumi.slack-manifest
...
SCHEMA_FILE     := provider/cmd/pulumi-resource-slack-manifest/schema.json
