...
namespace Pulumi.slack-manifest
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.slack-manifest.version.txt");
    ...
    internal sealed class slack-manifestResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public slack-manifestResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
