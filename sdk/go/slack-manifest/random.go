...
func NewRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.RegisterResource("slack-manifest:index:Random", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.ReadResource("slack-manifest:index:Random", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
