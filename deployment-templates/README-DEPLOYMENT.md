...
1. Customize .goreleaser.yml for your provider, replacing any instances of 'slack-manifest' with your provider's name, and paying special attention that the ldlflags are set to match your provider/go.mod exactly: 
